...
export const PERSONALITIES: readonly Personality[] = [
  ...
  { name: '残温', mbti: '温暖守护型',    direction: '温暖治愈（白花+橙花+麝香）',       tagline: '我的温度，恰好暖你一人',         description: '你有一种天然的治愈力，坐在你旁边就让人觉得安心。不争不抢，却让身边的人变得更好。' },
  ...
  { name: '烬生', mbti: '温柔力量型',    direction: '精致治愈（棉麻+玫瑰+白茶）',       tagline: '柔软是表，烈火在内',               description: '你是那种让人越相处越喜欢的人才。外表温柔得体，内心有自己的坚持，不张扬但有力量。' },
] as const;
