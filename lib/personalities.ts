...
const SHARE_QUOTES: Record<string, string> = {
  暗流:  '你不会注意到自己，但别人会记住你的味道。',
  荒岛:  '你让平凡的日子，也值得被期待。',
  残温:  '你的温柔，是这个世界欠你的利息。',
  裂岸:  '你的方向感，比任何导航都准。',
  寒岭:  '清醒不是冷漠，是你对自己最诚实的态度。',
  极夜:  '你追求的极致，本身就是一种美。',
  砾迹:  '你说话算话，这件事已经赢了。',
  冲浪:  '你的热情，是最好的社交货币。',
  温砾:  '你的快乐，愿意分一半给别人。',
