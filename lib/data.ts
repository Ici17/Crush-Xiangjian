...
// 香水总数（动态计算，首页 Hero 统计用）
export const TOTAL_PERFUMES = Object.keys(PERFUMES).length;
...
export const PERSONALITY_TYPES: PersonalityType[] = [
  ...
  },
  {
    ...
    signaturePerfume: PERFUMES["暖暖椰奶"],
    advancedPerfume: PERFUMES["颐和金桂"],
    budgetPerfume: PERFUMES["棉花糖星河"],
    matchingReport: {
  ...
  },
  {
    ...
    signaturePerfume: PERFUMES["檀木33"],
